...
#define grado 3 // Es la maxima cantidad de hijos (punteros) que puede tener un arbol.

//M es el grado del arbol B.---------- M-1 es el maximo de claves que puede tener.
// El numero minimo de claves en un nodo es min=[ceil(M-1)/2]-1; excepto en la raiz, el minimo de punteros M/2 en ambos el redondeo es hacia arriba
...
private:
	...
	bool _revisarCorregirNodo(NodoB*&, KY, DT);
};
